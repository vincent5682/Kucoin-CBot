   ...
   class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            _client.LoginAsync(0, "mfa.-lLAtDLpt-b2iFd1xz-v0p3Stz2bD2OJkDoxCSQeJ426JwDBP4R6hBM3-YtwRRsMuh5UKCzItgFf9vSVtf-h").GetAwaiter().GetResult();
            _client.StartAsync().GetAwaiter().GetResult();

            kucoinClient = new KucoinClient(new KucoinClientOptions()
            {
                ApiCredentials = new KucoinApiCredentials("61defc007c4b440001b8d416", "3a4f3faa-3313-480b-a163-5ed29ef40d77", "Tnecniv-04")
            });
